...
public class Gram_Schmidt {
	...
	private Vetor[] verificaDependencia(Vetor[] base) {
		...
		else { //deve ser igual a 1, se não tá errado
	...
	*/
	...
	private Vetor[] completeBase(Sistema system) {
		...
		//Fazer uma função para ordenar as linhas de forma que todos na diagonal sejam igual a 1(pode está ordenado mais)
